...
export default function PhoneNumberReveal({ phoneNumber, phoneNumberPretty, compact }: PhoneNumberRevealProps) {
  ...
  return (
    <div className="relative p-8 rounded-3xl bg-gray-50 dark:bg-gray-800/50 border border-[#B8860B]/20 dark:border-[#FFD700]/20 overflow-hidden animate-in fade-in duration-700">
      {/* Gold glow effect */}
      ...
      <div className="relative space-y-6 text-center">
        <div className="w-16 h-16 bg-[#FFD700]/10 rounded-2xl flex items-center justify-center mx-auto">
          <Phone className="text-[#B8860B] dark:text-[#FFD700]" size={28} />
        </div>

        <div className="space-y-2">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#B8860B] dark:text-[#FFD700]">
            Your AI Agent's Phone Line
          </p>
          <p className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-wider font-mono">
            {displayNumber}
          </p>
        </div>
        ...
        <button
          onClick={handleCopy}
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-gray-700/50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-sm font-bold transition-all"
        >
          {copied ? (
            <>
