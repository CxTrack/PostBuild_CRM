...
export const CA_PROVINCES = [
    { code: 'AB', name: 'Alberta', areaCode: 403 },
    ...
    { code: 'ON', name: 'Ontario', areaCode: 416 },
    { code: 'PE', name: 'Prince Edward Island', areaCode: 902 },
    { code: 'QC', name: 'Quebec', areaCode: 514 },
    { code: 'SK', name: 'Saskatchewan', areaCode: 306 },
...
export const US_STATES = [
    ...
    { code: 'AZ', name: 'Arizona', areaCode: 480 },
    { code: 'AR', name: 'Arkansas', areaCode: 501 },
    { code: 'CA', name: 'California', areaCode: 310 },
    { code: 'CO', name: 'Colorado', areaCode: 303 },
    { code: 'CT', name: 'Connecticut', areaCode: 203 },
    { code: 'DE', name: 'Delaware', areaCode: 302 },
    { code: 'FL', name: 'Florida', areaCode: 305 },
    { code: 'GA', name: 'Georgia', areaCode: 404 },
    ...
    { code: 'TX', name: 'Texas', areaCode: 214 },
    { code: 'UT', name: 'Utah', areaCode: 801 },
    { code: 'VT', name: 'Vermont', areaCode: 802 },
    { code: 'VA', name: 'Virginia', areaCode: 703 },
