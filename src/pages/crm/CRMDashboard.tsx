...
const CRMDashboard: React.FC = () => {
  ...
  const { leads, opportunities, fetchPipelineItem, deletePipelineItem } = usePipelineStore();
...
useEffect(() => {
  ...
  fetchTasks();
  fetchPipelineItem();
}, [fetchCustomers, fetchTasks, fetchPipelineItem]);
...
const confirmLeadDelete = async () => {
  ...
  try {
    ...
    deletePipelineItem(leadToDelete);
