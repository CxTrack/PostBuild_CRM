              ...
              <div>
                ...
                <input
                  ...
                  {...register('sku', { 
                    ...
                    maxLength: { 
                      value: 20, 
                      message: 'SKU cannot exceed 20 characters' 
                    },
                    validate: {
                      hasPrefix: v => v.startsWith('SKU-') || 'SKU must start with "SKU-"',
                      validLength: v => (v.length - 4) <= 16 || 'SKU number cannot exceed 16 characters'
                    },
                    onChange: (e) => {
                      // Ensure SKU- prefix remains
                      if (!e.target.value.startsWith('SKU-')) {
                        e.target.value = 'SKU-' + e.target.value.replace('SKU-', '');
                      }
              ...
              <div className="pt-4">
                ...
                <div className="flex items-center space-x-2">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-900/30 text-green-400">
                    Will be set automatically based on stock level
                  </span>
                </div>
              </div>
            </div>
