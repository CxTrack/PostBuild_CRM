/*
  # Fix for customers table migration

  This migration checks if the customers table and its policies already exist before attempting to create them.
  It uses DO blocks with conditional logic to prevent errors when objects already exist.
*/
